...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/almacen/almacenes-sucursales',[BranchWarehouseController::class,'index'])->name('branches.index'); Route::post('/almacen/almacenes-sucursales/sucursales',[BranchWarehouseController::class,'storeBranch'])->name('branches.store'); Route::post('/almacen/almacenes-sucursales/almacenes',[BranchWarehouseController::class,'storeWarehouse'])->name('warehouses.store'); Route::delete('/almacen/almacenes-sucursales/sucursales/{branch}',[BranchWarehouseController::class,'destroyBranch'])->name('branches.destroy'); Route::delete('/almacen/almacenes-sucursales/almacenes/{warehouse}',[BranchWarehouseController::class,'destroyWarehouse'])->name('warehouses.destroy');
    Route::get('/recepcion-productos',[ProductReceptionController::class,'index'])->name('product-receptions.index'); Route::post('/recepcion-productos',[ProductReceptionController::class,'store'])->name('product-receptions.store'); Route::delete('/recepcion-productos/{productReception}',[ProductReceptionController::class,'destroy'])->name('product-receptions.destroy');
    Route::get('/recepcion-productos/buscar-proveedores',[ProductReceptionController::class,'searchSuppliers'])->name('product-receptions.suppliers.search');
    ...
    Route::get('/requerimientos',[RequirementController::class,'index'])->name('requirements.index'); Route::post('/requerimientos',[RequirementController::class,'store'])->name('requirements.store'); Route::delete('/requerimientos/{requirement}',[RequirementController::class,'destroy'])->name('requirements.destroy');
    ...
    Route::get('/aprobaciones',[ApprovalController::class,'index'])->name('approvals.index'); Route::post('/aprobaciones/items/{requirementItem}',[ApprovalController::class,'decideItem'])->name('approvals.items.decide'); Route::post('/aprobaciones/ordenes/{purchaseOrder}',[ApprovalController::class,'decidePurchaseOrder'])->name('approvals.purchase-orders.decide'); Route::get('/aprobaciones/{requirement}/pdf',[ApprovalController::class,'pdf'])->name('approvals.pdf'); Route::post('/aprobaciones/{requirement}',[ApprovalController::class,'decide'])->name('approvals.decide'); Route::delete('/aprobaciones/{requirement}',[ApprovalController::class,'destroy'])->name('approvals.destroy');
    ...
    Route::post('/logistica/clientes-proveedores/bancos',[BusinessPartnerController::class,'storeBank'])->name('banks.store'); Route::post('/logistica/clientes-proveedores/cuentas-bancarias',[BusinessPartnerController::class,'storeBankAccount'])->name('business-partners.bank-accounts.store');
    Route::delete('/logistica/clientes-proveedores/bancos/{bank}',[BusinessPartnerController::class,'destroyBank'])->name('banks.destroy'); Route::delete('/logistica/clientes-proveedores/cuentas-bancarias/{bankAccount}',[BusinessPartnerController::class,'destroyBankAccount'])->name('business-partners.bank-accounts.destroy');
    Route::get('/logistica/ordenes-compra',[PurchaseOrderController::class,'index'])->name('purchase-orders.index'); Route::post('/logistica/ordenes-compra',[PurchaseOrderController::class,'store'])->name('purchase-orders.store'); Route::get('/logistica/ordenes-compra/correlativo',[PurchaseOrderController::class,'nextCorrelative'])->name('purchase-orders.next-correlative'); Route::get('/logistica/ordenes-compra/{purchaseOrder}/pdf',[PurchaseOrderController::class,'pdf'])->name('purchase-orders.pdf'); Route::post('/logistica/ordenes-compra/proveedores',[PurchaseOrderController::class,'storeSupplier'])->name('purchase-orders.suppliers.store'); Route::post('/logistica/ordenes-compra/cuentas-bancarias',[PurchaseOrderController::class,'storeBankAccount'])->name('purchase-orders.bank-accounts.store');
