...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/aprobaciones',[ApprovalController::class,'index'])->name('approvals.index'); Route::post('/aprobaciones/{requirement}',[ApprovalController::class,'decide'])->name('approvals.decide'); Route::delete('/aprobaciones/{requirement}',[ApprovalController::class,'destroy'])->name('approvals.destroy');
